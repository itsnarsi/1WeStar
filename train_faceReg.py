...
# @Last modified time: 2018-10-20T22:02:19-05:00
import numpy as np
...
model_instance_name = 'FACEMOD_2_E1'
...
model = FACEMOD_2(dataset.num_subs)

model_summary([1, 128, 128], model)
fit_model(model, dataset, loss_weight = 0.008, base_lr = 0.01,
          batch_size = batch_size, num_epochs = nb_epochs, init_epoch = 1,
          scheduler_setps = [20, 40, 80], log_dir = logging_dir,
